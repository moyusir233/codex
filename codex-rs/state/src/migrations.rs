...
// Workflow migrations currently include Fornax remote delivery proofs through v8.
pub(crate) static WORKFLOWS_MIGRATOR: Migrator = sqlx::migrate!("./workflows_migrations");
...
pub(crate) fn runtime_workflows_migrator() -> Migrator {
    runtime_migrator(&WORKFLOWS_MIGRATOR)
}
